<?php
$id=$_GET['id'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM pengembalian WHERE id='$id'") or die ("SQL Edit error");
        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Update Data Pengembalian Buku</h3>
                </div>
                <div class="panel-body">
                    <!--membuat form untuk tambah data-->
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            <label for="nope" class="col-sm-3 control-label">Nama Buku</label>
                             <div class="col-sm-9">
								<input type="text" name="nope" value="<?=$data['nama_buku']?>"class="form-control" id="inputEmail3" placeholder="Nama Buku" readonly="true">
                            </div>
                        </div>
                        <div class="form-group">
