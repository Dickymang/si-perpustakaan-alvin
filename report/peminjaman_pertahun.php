...
<html>
    <head>
        <title>Cetak Data Peminjaman Pertahun</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA PEMINJAMAN TAHUN   <? echo "$ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM peminjaman WHERE substr(tgl_masuk,1,4)='$ambilthn'";
